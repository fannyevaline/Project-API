...
async function changePassword(request, response, next) {
  try {
    ...
    const passwordConfirm = request.body.confirm_new_password; // Menggunakan request.body.passwordConfirm

    // Check if passwordConfirm is provided
    if (!passwordConfirm) {
